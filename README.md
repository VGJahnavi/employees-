
{
  ...
  "cells": [
      ...
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              ...
              "    (() => {\n",
              "      let quickchartButtonEl =\n",
              "        document.querySelector('#df-df646e0d-20ee-4cbb-ac34-cd02641e7c89 button');\n",
              "      quickchartButtonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "    })();\n",
              "  </script>\n",
    ...
    },
    {
      "cell_type": "code",
      "source": [
        "#check if the columns eixt befire applying grt_dummies\n",
        "if all(col in data.columns for col in['Company Type','WFH Setup Available','Gender']):\n",
        "  data=pd.get_dummies(data,columns=['Company Type','WFH Setup Available','Gender'],drop_first=True)\n",
        "  data.head()\n",
        "  encoded_columns=data.columns\n",
        "else:\n",
        "  print(\"Error:one or more of th specified columns are not pesent in the DataFrame.\")\n",
        "  print(data.columns)"
      ],
      "metadata": {
        "id": "Hd6BDP3oSbYv"
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "6UUocnDXUHMj",
        "outputId": "2ac9704e-ec54-41d7-b4f1-572e7aca5966"
      },
      "execution_count": 27,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-ffaf566f-61d3-4616-a1a0-dcd4352e964d\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              "        vertical-align: middle;\n",
              ...
              "\n",
              "  <div class=\"colab-df-container\">\n",
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-ffaf566f-61d3-4616-a1a0-dcd4352e964d')\"\n",
              "            title=\"Convert this dataframe to an interactive table.\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 -960 960 960\">\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-ffaf566f-61d3-4616-a1a0-dcd4352e964d button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-ffaf566f-61d3-4616-a1a0-dcd4352e964d');\n",
              "        const dataTable =\n",
              "          await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                    [key], {});\n",
              "        if (!dataTable) return;\n",
              ...
              "\n",
              "\n",
              "<div id=\"df-3b58a1b8-088f-468c-ac1f-6516028b1446\">\n",
              "  <button class=\"colab-df-quickchart\" onclick=\"quickchart('df-3b58a1b8-088f-468c-ac1f-6516028b1446')\"\n",
              "            title=\"Suggest charts\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "    (() => {\n",
              "      let quickchartButtonEl =\n",
              "        document.querySelector('#df-3b58a1b8-088f-468c-ac1f-6516028b1446 button');\n",
              "      quickchartButtonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "    })();\n",
              "  </script>\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "Lo6aldN7V6SV",
        "outputId": "13d75176-3ec2-4d11-aa25-8ed0d9db84fc"
      },
      "execution_count": 30,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-c25965ad-5956-4863-a9e1-65c7db4e4417\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              "        vertical-align: middle;\n",
              ...
              "\n",
              "  <div class=\"colab-df-container\">\n",
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-c25965ad-5956-4863-a9e1-65c7db4e4417')\"\n",
              "            title=\"Convert this dataframe to an interactive table.\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 -960 960 960\">\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-c25965ad-5956-4863-a9e1-65c7db4e4417 button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-c25965ad-5956-4863-a9e1-65c7db4e4417');\n",
              "        const dataTable =\n",
              "          await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                    [key], {});\n",
              "        if (!dataTable) return;\n",
              ...
              "\n",
              "\n",
              "<div id=\"df-4686c56a-fb40-4b7a-9477-6d34a8e5a74a\">\n",
              "  <button class=\"colab-df-quickchart\" onclick=\"quickchart('df-4686c56a-fb40-4b7a-9477-6d34a8e5a74a')\"\n",
              "            title=\"Suggest charts\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "    (() => {\n",
              "      let quickchartButtonEl =\n",
              "        document.querySelector('#df-4686c56a-fb40-4b7a-9477-6d34a8e5a74a button');\n",
              "      quickchartButtonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "    })();\n",
              "  </script>\n",
              "</div>\n",
              "\n",
              "  <div id=\"id_72be975a-849a-4495-8573-461fc4cf18b4\">\n",
              "    <style>\n",
              "      .colab-df-generate {\n",
              "        background-color: #E8F0FE;\n",
              "        border: none;\n",
              ...
              "      (() => {\n",
              "      const buttonEl =\n",
              "        document.querySelector('#id_72be975a-849a-4495-8573-461fc4cf18b4 button.colab-df-generate');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      buttonEl.onclick = () => {\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "0gCiLtxwV_p6",
        "outputId": "3b02a843-c702-41f7-b8e7-63c7cb0092ce"
      },
      "execution_count": 32,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "AUdJRIAQdFd0",
        "outputId": "16ed8461-3719-4127-f0e6-5fb257d0ed28"
      },
      "execution_count": 62,
      "outputs": [
        {
          ...
          "text": [
            "SVM model performance metrics:\n",
            "\n",
            "Mean Squared Error: 0.1442134490056022\n",
            "Root Mean Squared Error: 0.379754458835709\n",
            "Mean Absolute Error: 0.28602535783430844\n",
            "R-Squared Score: -2.7082496161046836\n"
          ]
        }
      ]
    }
